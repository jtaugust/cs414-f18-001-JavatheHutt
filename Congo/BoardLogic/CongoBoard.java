...
public class CongoBoard extends JFrame implements MouseListener, MouseMotionListener {
  ...
  //set lock to true when user requesting the board is not the active turn player
  private Boolean lock = false;
  private String user1 = "", user2 = "";
  String turn = "White"; //starting turn is white
  //TODO:
  //method to prevent user input on the board
  //when turn is white, players[1] user can move, disable players[2] user
  String players[] = new String[] {user1, user2};
  //TODO:
  //method to display the board properly.
  //when turn switches, flip board so that the logic will match with the board
  	//when the player who is waiting for their turn requests the board, flip the board
  	//then call the TODO method described above
  	//when the user input is locked, the board is NOT saved to the server
  
  
  //TODO:
  //make it so clicking on the out numbers/letters dont make any response
  //right now, clicking on them prints the index they are at
